...
C {FULL_SCH_FILE/CHOPPER SWITCHES/switch_A.sym} -40 -170 0 0 {name=x1}
C {FULL_SCH_FILE/CHOPPER SWITCHES/switch_A.sym} 260 -170 0 0 {name=x2}
C {FULL_SCH_FILE/CHOPPER SWITCHES/switch_A.sym} 560 -170 0 0 {name=x3}
C {FULL_SCH_FILE/CHOPPER SWITCHES/switch_A.sym} 850 -170 0 0 {name=x4}
